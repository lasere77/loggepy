...
setx path "%path%;C:\Program Files (x86)\loggepy\Script\python3.10.4;"
...
mkdir Script
xcopy "%paths%\Script" "C:\Program Files (x86)\loggepy\Script" /e
...
cd C:\Program Files (x86)\loggepy
xcopy "%paths%\passworld" "C:\ProgramData\passworld_loggepy" /e
del update.bat /s /q
...
python -m pip install cryptography==37.0.3
